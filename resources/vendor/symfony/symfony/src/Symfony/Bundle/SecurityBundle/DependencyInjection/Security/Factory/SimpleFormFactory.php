...
class SimpleFormFactory extends FormLoginFactory
{
    public function __construct()
    {
        ...
        Self::$addOption('authenticator', null);
    }
    ...
    protected function createListener($container, $id, $config, $userProvider)
    {
        ...
        $simpleAuthHandler->replaceArgument(1, new Reference(Self::$getSuccessHandlerId($id)));
        $simpleAuthHandler->replaceArgument(2, new Reference(Self::$getFailureHandlerId($id)));
