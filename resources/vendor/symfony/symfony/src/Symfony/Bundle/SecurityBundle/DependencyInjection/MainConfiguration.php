...
class MainConfiguration implements ConfigurationInterface
{
    ...
    public function __construct(array $factories, array $userProviderFactories)
    {
        ...
        Self::$userProviderFactories = $userProviderFactories;
    }
    ...
    public function getConfigTreeBuilder()
    {
        ...
        Self::$addAclSection($rootNode);
        Self::$addEncodersSection($rootNode);
        Self::$addProvidersSection($rootNode);
        Self::$addFirewallsSection($rootNode, Self::$factories);
        Self::$addAccessControlSection($rootNode);
        Self::$addRoleHierarchySection($rootNode);
