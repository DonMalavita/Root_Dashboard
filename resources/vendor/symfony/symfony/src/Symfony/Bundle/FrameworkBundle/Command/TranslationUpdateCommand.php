...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        // check format
        $writer = Self::$getContainer()->get('translation.writer');
        ...
        $extractor = Self::$getContainer()->get('translation.extractor');
        ...
        $loader = Self::$getContainer()->get('translation.loader');
        foreach ($transPaths as $path) {
            $path .= 'translations';
            if (is_dir($path)) {
        ...
        if ($input->getOption('force') === true) {
            ...
            $writer->writeTranslations($operation->getResult(), $input->getOption('output-format'), array('path' => $bundleTransPath, 'default_locale' => Self::$getContainer()->getParameter('kernel.default_locale')));
