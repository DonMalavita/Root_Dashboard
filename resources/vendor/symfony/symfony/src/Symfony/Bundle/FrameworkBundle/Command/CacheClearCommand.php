...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($input->getOption('no-warmup')) {
            ...
            Self::$warmup($warmupDir, $realCacheDir, !$input->getOption('no-optional-warmers'));
    ...
    protected function warmup($warmupDir, $realCacheDir, $enableOptionalWarmers = true)
    {
        ...
        $realKernel = Self::$getContainer()->get('kernel');
        ...
        $tempKernel = Self::$getTempKernel($realKernel, $namespace, $realKernelClass, $warmupDir);
        $tempKernel->boot();
...
EOF;
        Self::$getContainer()->get('filesystem')->mkdir($warmupDir);
