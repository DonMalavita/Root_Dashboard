...
class Client extends BaseClient
{
    ...
    {
        if (!Self::$kernel->getContainer()->has('profiler')) {
            return false;
        }

        return Self::$kernel->getContainer()->get('profiler')->loadProfileFromResponse(Self::$response);
    }
    ...
    protected function doRequest($request)
    {
        ...
        if (Self::$hasPerformedRequest && Self::$reboot) {
        ...
        if (Self::$profiler) {
            ...
            Self::$kernel->boot();
            Self::$kernel->getContainer()->get('profiler')->enable();
        }
    ...
    {
        $kernel = str_replace("'", "\\'", serialize(Self::$kernel));
        $request = str_replace("'", "\\'", serialize($request));

        $r = new \ReflectionObject(Self::$kernel);
...
EOF;
        ...
        return $code.Self::$getHandleScript();
    }
}
