...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!Self::$getContainer()->has($mailerServiceName)) {
        ...
        $mailer = Self::$getContainer()->get($mailerServiceName);
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $questionHelper = Self::$getHelperSet()->has('question') ? Self::$getHelperSet()->get('question') : Self::$getHelperSet()->get('dialog');
    ...
    {
        return Self::$getContainer()->has('mailer');
    }
