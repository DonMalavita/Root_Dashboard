...
function autoloader($class_paths = NULL, $use_base_dir = true)
{
    ...
    $conf = [
        'basepath' => 'C:\\wamp\\apache2\\htdocs\\Root_Dashboard\\resources\\librarys\\',
        'debug' => Config::get("admin/debug"),
        'extensions' => ['.class.php'], // multiple extensions ex: ['.php', '.class.php']
        'namespace' => 'ClassAutoLoader',
        'verbose' => Config::get("admin/verbose"),
    ];
