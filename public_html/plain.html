...
<html lang="en">
  <head>
    ...
    <!-- Custom Theme Style -->
    <link href="../public_html/css/custom.min.css" rel="stylesheet">
  </head>
  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Home Page</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="../public_html/images/user.png" alt="..." class="img-circle profile_img">
              </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Projects <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="index2.html">Add Project</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i>Toolz<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Spider Dashboard</a></li>
                      <li><a href="form_advanced.html">Flush Database</a></li>
    ...
    <script src="../public_html/js/custom.min.js"></script>
  </body>
</html>
